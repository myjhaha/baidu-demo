function Graph_SearchDijkstra(opt){
  opt = opt || {};
...
Graph_SearchDijkstra.prototype.runFindPath = function*(from,to, graph, pathFinder){
  ...
  if(startNode === undefined || startNode === null){
    throw new Error("DijkstraFinder: Cannot get startNode.");
  }
  if(endNode === undefined || endNode === null){
    throw new Error("DijkstraFinder: Cannot get endNode.");
  }
